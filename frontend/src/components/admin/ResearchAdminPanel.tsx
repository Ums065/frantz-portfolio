  ...
  return (
    <div style={{ display: 'grid', gap: 14, minWidth: 0 }}>
      <div style={{ background: 'rgba(201,168,76,0.06)', border: '1px solid var(--line)', borderRadius: 12, padding: '13px 16px' }}>
        <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: '.05em', textTransform: 'uppercase', color: 'var(--gold)' }}>Research Entries</div>
        <p style={{ color: '#d8d3c6', fontSize: 13, lineHeight: 1.6, margin: '5px 0 0' }}>
          What the Fellows collected: partners, funders, creators and research notes. Review each entry, push a verified
          school contact into your Schools data, or export a category to CSV. Accounts live under <strong>Fellow Accounts</strong>,
          assigned work under <strong>Tasks</strong>, and the master school list under <strong>School Verification</strong>.
        </p>
      </div>
      {err && <p style={{ color: '#ff9a9a', fontSize: 13 }}>{err}</p>}

      {/* Account creation and task assignment moved to their own sections of the
          Fellow Team panel; only the bulk importer belongs with the entries. */}
