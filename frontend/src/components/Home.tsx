    ...
    <>
      ...
      {featuredEvent && (
        <section className="block feat-event" id="featured-event" data-screen-label="Event">
          <div className="wrap">
            <article className={`feat-event__card reveal in${featuredEvent.image_url ? '' : ' feat-event__card--noimg'}`}>
              ...
              {featuredEvent.image_url && (
                <div className="feat-event__media">
                  ...
                  <span className="feat-event__date-chip" aria-hidden="true">
                    <span className="m">{monthAbbr(featuredEvent.event_date)}</span>
                    <span className="d">{dayNum(featuredEvent.event_date)}</span>
                  </span>
                </div>
              )}
              <div className="feat-event__body">
                ...
                <div className="feat-event__meta">
                  <span className="feat-event__meta-item">
                    ...
                    {fmtFullDate(featuredEvent.event_date)}
                  </span>
                ...
                <Link className="btn btn--solid feat-event__cta" to="/events">
                  RSVP / View Details
