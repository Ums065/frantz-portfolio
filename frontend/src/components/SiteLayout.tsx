    ...
    <>
      ...
      <div className="lightbox" id="lightbox">
        ...
        <div className="lightbox__inner">
          <div className="lightbox__frame"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.2}><rect x="3" y="5" width="18" height="14" rx="2" /><circle cx="8.5" cy="10" r="2" /><path d="M21 17l-5-5-7 6" /></svg></div>
